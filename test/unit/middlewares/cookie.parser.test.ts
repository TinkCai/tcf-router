...
describe('cookieParser', () => {
  ...
  it('should call next() if cookies already exist', async () => {
    ...
    await cookieParser(mockRequest as TcfApiRequest, mockResponse as TcfApiResponse, next);
  ...
  it('should handle multiple cookies', async () => {
    mockRequest.headers = { cookie: 'cookie1=value1; cookie2=value2; cookie3=value3' };
  ...
  it('should handle JSON-encoded signed cookies', async () => {
    ...
    const signedJson = 's:' + signature.sign('j:' + JSON.stringify(jsonData), secret);
